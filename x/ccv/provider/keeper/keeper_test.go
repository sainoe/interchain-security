...
// TestHandleSlashPacketDistribution tests the slashing of unbonding tokens
// by variying slash packets' VSC ID. The mapped infraction heights
// must be greater or equal the unbonding creation height to slash the tokens.
